...
namespace Te {
	...
	namespace HttpFilteringEngine
	{
		...
		public ref class Engine : IHttpFilteringEngine
		{
		...
		public:
			...
			/// be empty.
			/// </returns>
			property array<System::Byte>^ RootCaPEM
			{
			public:

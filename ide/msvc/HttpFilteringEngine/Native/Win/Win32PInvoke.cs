...
{
    internal class Win32PInvoke : AbstractEngine
    {
        ...
        public override bool IsRunning
        {
            get
            {
                ...
                {
                    return NativeMethods32.fe_ctl_is_running(m_engineHandle);
                }
        ...
        public override ushort HttpListenerPort
        {
            get
            {
                if (m_engineHandle != IntPtr.Zero)
                {
                    return NativeMethods32.fe_ctl_get_http_listener_port(m_engineHandle);
                }
        ...
        public override ushort HttpsListenerPort
        {
            get
            {
                if (m_engineHandle != IntPtr.Zero)
                {
                    return NativeMethods32.fe_ctl_get_https_listener_port(m_engineHandle);
                }
        ...
        internal Win32PInvoke(string caBundleAbsPath, ushort preferredHttpListeningPort = 0, ushort preferredHttpsListeningPort = 0) : base(caBundleAbsPath, preferredHttpListeningPort, preferredHttpsListeningPort)
        {
            m_engineHandle = NativeMethods32.fe_ctl_create(NativeFirewallCbReference, caBundleAbsPath, (uint)caBundleAbsPath.Length, preferredHttpListeningPort, preferredHttpsListeningPort, (uint)Environment.ProcessorCount, NativeHttpMsgBeginCbReference, NativeHttpMsgEndCbReference, NativeOnInfoCbReference, NativeOnWarnCbReference, NativeOnErrorCbReference);
        ...
        public override bool Start()
        {
            if (m_engineHandle != IntPtr.Zero)
            {
                return NativeMethods32.fe_ctl_start(m_engineHandle);
            }
        ...
        public override void Stop()
        {
            if (m_engineHandle != IntPtr.Zero)
            {
                NativeMethods32.fe_ctl_stop(m_engineHandle);
            }
        }
        ...
        protected override void DisposeNativeEngine()
        {
            ...
            if(m_engineHandle != IntPtr.Zero && m_engineHandle != new IntPtr(-1))
            {
                NativeMethods32.fe_ctl_destroy(ref m_engineHandle);
            }
        }

        private class NativeMethods32
        {
            [DllImport(@"x86\HttpFilteringEngine.dll", EntryPoint = "fe_ctl_create", CallingConvention = CallingConvention.Cdecl)]
            ...
            /// Return Type: void
            ///ptr: PVOID*
            [DllImport(@"x86\HttpFilteringEngine.dll", EntryPoint = "fe_ctl_destroy", CallingConvention = CallingConvention.Cdecl)]
            public static extern void fe_ctl_destroy(ref IntPtr ptr);


            /// Return Type: void
            ///ptr: PVOID->void*
            [DllImport(@"x86\HttpFilteringEngine.dll", EntryPoint = "fe_ctl_destroy_unsafe", CallingConvention = CallingConvention.Cdecl)]
            public static extern void fe_ctl_destroy_unsafe(IntPtr ptr);


            /// Return Type: boolean
            ///ptr: PVOID->void*
            [DllImport(@"x86\HttpFilteringEngine.dll", EntryPoint = "fe_ctl_start", CallingConvention = CallingConvention.Cdecl)]
            ...
            /// Return Type: void
            ///ptr: PVOID->void*
            [DllImport(@"x86\HttpFilteringEngine.dll", EntryPoint = "fe_ctl_stop", CallingConvention = CallingConvention.Cdecl)]
            public static extern void fe_ctl_stop(IntPtr ptr);


            /// Return Type: boolean
            ///ptr: PVOID->void*
            [DllImport(@"x86\HttpFilteringEngine.dll", EntryPoint = "fe_ctl_is_running", CallingConvention = CallingConvention.Cdecl)]
            [return: MarshalAs(UnmanagedType.I1)]
            ...
            ///ptr: PVOID->void*
            [DllImport(@"x86\HttpFilteringEngine.dll", EntryPoint = "fe_ctl_get_http_listener_port", CallingConvention = CallingConvention.Cdecl)]
            public static extern ushort fe_ctl_get_http_listener_port(IntPtr ptr);


            /// Return Type: uint16_t->unsigned short
            ///ptr: PVOID->void*
            [DllImport(@"x86\HttpFilteringEngine.dll", EntryPoint = "fe_ctl_get_https_listener_port", CallingConvention = CallingConvention.Cdecl)]
            ...
            ///bufferPP: char**
            ///bufferSize: size_t*
            [DllImport(@"x86\HttpFilteringEngine.dll", EntryPoint = "fe_ctl_get_rootca_pem", CallingConvention = CallingConvention.Cdecl)]
